...
const createBarber = async (req, res) => {
  ...
  try {
    const { name, experienceYears, chairId, phone, avatar } = req.body;
    if (chairId) {
    ...
    const barber = await Barber.create({ name, experienceYears, chairId, phone, avatar });
...
module.exports = { getAllBarbers, getBarberById, createBarber, updateBarber, deleteBarber, getBarberSchedule };
